...
## Guía de Prioridades (Tiempos de Atención)
- **Crítico:** [Placeholder: Tiempo de respuesta sugerido] - Sistema caído o pérdida de datos.
- **Alto:** [Placeholder: Tiempo de respuesta sugerido] - Funcionalidad principal afectada.
- **Normal:** [Placeholder: Tiempo de respuesta sugerido] - Problemas visuales o molestias menores.

## Notas
- La "Causa Raíz" debe explicar por qué ocurrió el fallo, no solo qué falló.
- La "Solución Aplicada" debe describir los cambios realizados en el código.