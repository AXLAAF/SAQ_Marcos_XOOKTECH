...
## 2. Cliente
- **Nombre del negocio:** Enmárcame
- **Representante:** Analista de Verificación y Pruebas
- **Ubicación:** Mérida, Yucatán
## 3. Descripción general y problema que resuelve
### 3.1. Descripción
...
## 4. Costo y Modelo de Negocio (resumen de alto nivel)
...
El costo de desarrollo incluye:
...
## 5. Entregables Definidos (lista de entregables principales)
