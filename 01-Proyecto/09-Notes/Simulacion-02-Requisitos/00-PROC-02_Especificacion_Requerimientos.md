...
|Matriz de Trazabilidad de Requisitos (RTM)|[[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-STD-03_Matriz_Trazabilidad|STD-03]]|
|REQ-01 Carga de Imagen del Cliente|[[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/01-REQ-01_Carga_Imagen|01-REQ-01_Carga_Imagen]]|
|REQ-02 Previsualización de Marco Interactivo|[[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/05-REQ-02_Previsualizacion_Marco|05-REQ-02_Previsualizacion_Marco]]|
|REQ-03 Generación de Marcos 3D (Pillow)|[[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/06-REQ-03_Generacion_Marcos_3D|06-REQ-03_Generacion_Marcos_3D]]|
|REQ-04 Catálogo de Marcos Disponibles|[[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/02-REQ-04_Catalogo_Marcos|02-REQ-04_Catalogo_Marcos]]|
|REQ-05 Filtrado de Catálogo en Servidor|[[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/03-REQ-05_Filtrado_Catalogo|03-REQ-05_Filtrado_Catalogo]]|
|REQ-06 Datos del Catálogo de Marcos|[[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/04-REQ-06_Datos_Catalogo|04-REQ-06_Datos_Catalogo]]|
...
- El Analista de Requerimientos vincula el origen del requerimiento con la solicitud de cambio (Change Request) de la cual proviene:
    - Las solicitudes de cambio pendientes de especificación se registran físicamente en:
        - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/00-Pendientes/07-REQ-07_Marcos_Dobles|REQ-07 Marcos Dobles]] (derivado de la solicitud de cambio [[07-Control/01-Ingenieria_Control/08-CR-01_Marcos_Dobles|CR-01 Marcos Dobles]]).
        - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/00-Pendientes/08-REQ-08_Tipo_Vidrio|REQ-08 Tipo de Vidrio]] (derivado de la solicitud de cambio [[07-Control/01-Ingenieria_Control/09-CR-02_Tipos_Vidrio|CR-02 Tipos de Vidrio]]).
        - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/00-Pendientes/09-REQ-09_Maria_Luisa|REQ-09 María Luisa]] (derivado de la solicitud de cambio [[07-Control/01-Ingenieria_Control/10-CR-03_Maria_Luisa|CR-03 María Luisa]]).
        - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/00-Pendientes/10-REQ-10_Pantalla_Secundaria|REQ-10 Pantalla Secundaria]] (derivado de la solicitud de cambio [[07-Control/01-Ingenieria_Control/11-CR-04_Pantalla_Secundaria|CR-04 Pantalla Secundaria]]).
...
- El Analista de Requerimientos edita el archivo `REQ-XXX` en la carpeta de pendientes para detallarlo técnicamente, utilizando de referencia la estructura y completitud de los requisitos ya aprobados:
    - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/01-REQ-01_Carga_Imagen|REQ-01 Carga de Imagen]] (criterios de carga de formatos JPG/PNG, límite de 10 MB y compresión local).
    - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/05-REQ-02_Previsualizacion_Marco|REQ-02 Previsualización Marco]] (lógica del visor y margen del marco interactivo).
    - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/06-REQ-03_Generacion_Marcos_3D|REQ-03 Generación Marcos 3D]] (criterios de superposición y renderizado del marco).
    - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/02-REQ-04_Catalogo_Marcos|REQ-04 Catálogo de Marcos]] (catálogo de marcos disponibles).
    - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/03-REQ-05_Filtrado_Catalogo|REQ-05 Filtrado Catálogo]] (filtrado por modelo, color y ancho).
    - [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-Aprobados/04-REQ-06_Datos_Catalogo|REQ-06 Datos Catálogo]] (criterios de persistencia de datos de catálogo).
...
- Para los requisitos adicionales, se valida el impacto técnico y estimación contra su correspondiente solicitud de cambio:
    - Ejemplo: Validar [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/00-Pendientes/07-REQ-07_Marcos_Dobles|REQ-07]] contra el alcance y viabilidad planteados en [[07-Control/01-Ingenieria_Control/08-CR-01_Marcos_Dobles|CR-01 Marcos Dobles]].
...
- El Analista de Requerimientos actualiza de inmediato la Matriz de Trazabilidad de Requisitos (RTM) ([[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-STD-03_Matriz_Trazabilidad|STD-03]]) mapeando y documentando las siguientes relaciones:
...
[5] Matriz de Trazabilidad de Requisitos (RTM). [[09-Notes/Simulacion-02-Requisitos/01-Ingenieria_Requisitos/01-STD-03_Matriz_Trazabilidad|STD-03]]