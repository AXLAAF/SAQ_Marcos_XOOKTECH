...
- [ ] * **Idioma.** ¿El código y los comentarios están escritos íntegramente en español?
...
- [ ] * **Commit.** El mensaje del commit incluye el folio de la tarea (TAR-YYYY-NNN).

---
**Programador:** ________________________________  
**Fecha:** ________________________________

**Revisión por Pares (Peer Review):**
*(Si el equipo es de una sola persona, realice la revisión al día siguiente con la mente fresca y marque la casilla de Autocontrol).*
