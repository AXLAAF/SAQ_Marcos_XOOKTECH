# Registro de Tareas de Desarrollo (REG-04-01)
...
## Notas
- El folio de tarea debe ser correlativo.
- El programador debe actualizar el estado a "Listo" solo después de pasar la verificación de código.