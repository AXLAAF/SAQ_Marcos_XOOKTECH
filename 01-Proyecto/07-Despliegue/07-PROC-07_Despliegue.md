...
| :--- | :--- | :--- | :--- |
| **CL-08-01** | Checklist de Despliegue | Lista de verificación final antes de pasar a "En Vivo". | [[07-Despliegue/Documentos_Apoyo/02-Formatos/CL-08-01_Verificacion_Despliegue|CL-08-01]] |
| **REG-08-01** | Registro de Entornos | Documentar IP, puertos y versiones del VPS. | [[07-Despliegue/Documentos_Apoyo/01-Registros/REG-08-01_Entornos_Servidores|REG-08-01]] |
| **FOR-08-01** | Configuración de Proyecto | Plantilla de variables `.env` y configuraciones Nginx. | [[07-Despliegue/Documentos_Apoyo/02-Formatos/FOR-08-01_Configuracion_Proyecto|FOR-08-01]] |
