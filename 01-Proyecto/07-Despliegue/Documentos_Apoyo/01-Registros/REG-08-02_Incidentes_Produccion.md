...
## Notas
- Un incidente se considera cerrado solo cuando la disponibilidad del servicio es del 100% y se ha analizado el impacto.
- Si el incidente fue causado por un despliegue, refiera el folio de la Lista de Verificación (CL-08).