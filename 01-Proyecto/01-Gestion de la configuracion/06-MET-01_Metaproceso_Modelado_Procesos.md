...
Assignments_V2/
│
├── 01-Gestion de la configuracion/                     <-- GOBERNANZA GLOBAL (Nivel 1)
│   ├── 01-PROC-01_Gobernanza_Vault.md
...
└── 01-Proyecto/
    └── 09-Notes/
        └── Preview-02-Requisitos/  <-- ENTORNO SEGURO DE TRABAJO Y PREPARACIÓN (Nivel 2)
            ...
            ├── 02-PROC-02_Especificacion_Requerimientos.md  <-- (El proceso ejecutable)
