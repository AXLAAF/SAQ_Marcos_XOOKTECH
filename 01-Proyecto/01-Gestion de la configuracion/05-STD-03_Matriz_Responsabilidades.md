...
Para garantizar la independencia de criterio, el control de la calidad y el cumplimiento riguroso de los hitos del prototipo de la **Aplicación Web**, el equipo se organiza bajo una estructura despersonalizada de **cinco (5) roles institucionales**. 
...
- **Ámbito de Acción:** Fase 00 (Gobernanza) y Fase 03 (Diseño).
- **Competencias Técnicas:** Gestión documental, diseño de arquitectura de software y modelado de bases de datos.
- **Entregables Clave:** PROC-01 (Gobernanza del Vault), PROC-03 (Proceso de Diseño), Diagrama de Componentes (STD-04), Flujo del Sistema (STD-05), Modelo de Datos (STD-06) y Arquitectura de Módulos (STD-07).
...
- **Competencias Técnicas:** Programación y desarrollo web del backend y frontend, control de versiones (Git) y configuración de servidores de aplicaciones y web.
- **Entregables Clave:** PROC-04 (Codificación), Registro de Tareas de Desarrollo (REG-04-01), Estándar de Codificación (FOR-04-01), Código Fuente, PROC-07 (Despliegue) y Guía de Configuración (FOR-07-01).
...
- **Ámbito de Acción:** Fase 07 (Control y Cambios) y Fase 08 (Mantenimiento).
- **Competencias Técnicas:** Software Configuration Management (SCM), auditorías documentales, control de cambios, inspecciones formales de código/requisitos, soporte técnico post-entrega y métricas de calidad.
- **Entregables Clave:** PROC-05 (Control de Cambios), PROC-08 (Mantenimiento), Tablero de Calidad (STD-08), Registro de Defectos (REG-03), Reportes de Inspección (INS-01, INS-02), Solicitudes de Cambio (CR-00 a CR-04) y Bitácora de Mantenimiento.
...
| **04-Codificación: Código Fuente Backend/API** | I | I | **A / R** | C | S |
...
| **08-Mantenimiento: PROC-08 Soporte** | I | I | S | I | **A / R** |
...
| **07-Despliegue: PROC-07 Guía** | I | I | **A / R** | I | S |
