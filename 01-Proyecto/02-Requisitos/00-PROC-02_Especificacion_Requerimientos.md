...
| **[V] Verification** | Verificacion de Calidad | Aplicacion de [[CL-02_Verificacion_Requerimientos]] + [[PROC-06_Inspecciones]]. |
...
- **Post-requisito**: [[PROC-03_Control_Cambios]] (Gestiona cambios en REQ especificados), [[PROC-05_Plan_Pruebas]] (Crea casos de prueba basados en REQ detallados)
