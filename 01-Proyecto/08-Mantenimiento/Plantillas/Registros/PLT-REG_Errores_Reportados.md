# [PLT-REG_Errores_Reportados] Registro de Errores Reportados
...
*   Documente en esta bitácora todos los fallos lógicos u operativos (bugs) reportados por el cliente o identificados en producción para su seguimiento.
*   Priorice cada error según la guía descrita abajo.
