...
| Diagrama de Componentes del Sistema | [[03-Diseño/01-Ingenieria_Diseño/01-STD-04_Diagrama_Componentes|STD-04]] |
| Flujo del Sistema y Secuencia HTTP | [[03-Diseño/01-Ingenieria_Diseño/02-STD-05_Flujo_Sistema|STD-05]] |
| Modelo de Datos y Esquema Técnico | [[03-Diseño/01-Ingenieria_Diseño/03-STD-06_Modelo_Datos|STD-06]] |
| Arquitectura del Código Python | [[03-Diseño/01-Ingenieria_Diseño/04-STD-07_Arquitectura_Python|STD-07]] |
| Registro de Inconsistencia Tecnológica | [[03-Diseño/02-Calidad_Diseño/HALLAZGO-01_Inconsistencia_Tecnologica|HALLAZGO-01]] |
...
4. **Paso 4 o Inicialización del Diseño:** Crea una nota borrador en el entorno de previsualización `03-Diseño/01-Ingenieria_Diseño/` por cada estándar técnico (`STD-04` a `STD-07`) y de calidad (`HALLAZGO-01`) que requiera actualización.
...
6. **Paso 6 o Modelar arquitectura de componentes:** El Analista de Gobernanza y Diseño diseña el diagrama de bloques estructurado de componentes en [[03-Diseño/01-Ingenieria_Diseño/01-STD-04_Diagrama_Componentes|STD-04]], separando físicamente el Cliente (HTML/CSS/Three.js), el Servidor Flask API, el Motor de Procesamiento (OpenCV) y Pillow.
...
8. **Paso 8 o Mapear secuencia HTTP y flujo dinámico:** Diseña en el estándar [[03-Diseño/01-Ingenieria_Diseño/02-STD-05_Flujo_Sistema|STD-05]] los diagramas de secuencia Mermaid.js que detallan el ciclo de vida de las llamadas asíncronas para carga de fotos (`/upload`) y selección de marcos (`/process`).
9. **Paso 9 o Reconstruir esquema de datos:** Diseña el diagrama Entidad-Relación y el diccionario de datos físico en el estándar [[03-Diseño/01-Ingenieria_Diseño/03-STD-06_Modelo_Datos|STD-06]], especificando llaves primarias, tipos SQLite y constantes del catálogo.
...
12. **Paso 12 o Detección de desviaciones:** En caso de hallar diferencias (como uso de librerías no planificadas o inconsistencia en nombres de variables), el Analista de Gobernanza y Diseño, en coordinación independiente con el Analista de Control y Cambios, las documenta formalmente en el registro [[03-Diseño/02-Calidad_Diseño/HALLAZGO-01_Inconsistencia_Tecnologica|HALLAZGO-01]].
...
18. **Paso 18 o Publicación de Inventario de Módulos:** El Analista de Gobernanza y Diseño documenta y congela el inventario de módulos definitivo en el estándar [[03-Diseño/01-Ingenieria_Diseño/04-STD-07_Arquitectura_Python|STD-07]].
