...
|---|---|
|Acta de Inicio|[[01-Linea_Base/01-Acta_Inicio|01-Acta_Inicio]]|
...
|Guía de Entrevista PO|[[01-Linea_Base/04-Guia_Entrevista_PO|04-Guia_Entrevista_PO]]|
|Minuta de Entrevista|[[01-Linea_Base/05-Minuta_Entrevista|05-Minuta_Entrevista]]|
|Contrato de Desarrollo|[[01-Linea_Base/06-Contrato_Desarrollo|06-Contrato_Desarrollo]]|
...
- Diseña y estructura previamente la [[01-Linea_Base/04-Guia_Entrevista_PO|Guía de Entrevista PO (04-Guia_Entrevista_PO)]], delimitando las preguntas clave sobre dimensiones físicas, formatos y lógica de marcos.
- Crea y formaliza el [[01-Linea_Base/01-Acta_Inicio|Acta de Inicio (01-Acta_Inicio)]] para detallar el propósito y asegurar la participación equitativa de los 5 roles asignados.
...
- El Analista de Requerimientos ejecuta la entrevista apegándose a la guía estructurada y documenta textualmente las respuestas en la [[01-Linea_Base/05-Minuta_Entrevista|Minuta de Entrevista (05-Minuta_Entrevista)]].
- Concentra todos los compromisos funcionales y comerciales detallados con el Product Owner en el documento estructurado [[01-Linea_Base/03-Acuerdos_Cliente|Acuerdos del Cliente (03-Acuerdos_Cliente)]], sirviendo de respaldo formal ante cambios imprevistos.
...
- Redacta de forma detallada la [[01-Linea_Base/02-Propuesta_Recuperada|Propuesta Recuperada (02-Propuesta_Recuperada)]], documentando la arquitectura preliminar del sistema, la cotización estimada de esfuerzo y los casos de uso recuperados por ingeniería inversa.
...
- El Analista de Requerimientos realiza una inspección y mapeo de las cláusulas y requerimientos de alcance especificados en el [[01-Linea_Base/06-Contrato_Desarrollo|Contrato de Desarrollo (06-Contrato_Desarrollo)]] frente a la propuesta recuperada.
